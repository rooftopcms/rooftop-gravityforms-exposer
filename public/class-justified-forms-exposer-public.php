 ...
 * @subpackage Justified_Forms_Exposer/public
 */
 ...
 */
class Justified_Forms_Exposer_Public {
	...
	public function enqueue_styles() {
		 ...
		 * defined in Justified_Forms_Exposer_Loader as all of the hooks are defined
		 * in that particular class.
		 *
		 * The Justified_Forms_Exposer_Loader will then create the relationship
		 * between the defined hooks and the functions defined in this
		 * class.
		 */

		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/justified-forms-exposer-public.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/justified-forms-exposer-public.js', array( 'jquery' ), $this->version, false );
